          ...
          <>
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. 18"
                className={`w-full px-3 py-2 border border-gray-200 rounded-lg text-sm bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-slate-400 ${errors.gst ? 'border-red-400' : 'border-gray-200'}`}
              />
