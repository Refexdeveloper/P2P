...
export default function KPIWidgets({ kpis }: { kpis: Kpis }) {
  const widgets = [
    {
      title: 'Total PO Amount',
      value: formatCurrency(kpis.totalPOAmount),
    ...
    },
    {
      ...
      value: formatCurrency(kpis.entityWiseSpend),
      subtext: `Across ${kpis.entityCount || 0} Entities`,
    ...
    },
    {
      ...
      value: formatCurrency(kpis.approvedPOAmount),
    ...
    },
    {
      ...
      value: formatCurrency(kpis.pendingPOAmount),
    ...
    },
    {
      ...
      value: formatCurrency(kpis.totalVendorPayments),
