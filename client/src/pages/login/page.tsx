...
const demoAccounts = [
  ...
  },
  {
    ...
    description: 'L2 manager ΓÇö RFQ vendor comparison & approval',
  },
  {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-10 max-w-md w-full text-center">
          ...
          <p className="text-sm text-slate-600">
            Detected your RefexOne session ΓÇö completing automatic loginΓÇª
          </p>
        </div>
      </div>
    );
            ...
            {activeDemo && (
              <div className="mt-2.5 bg-slate-50 rounded-lg px-3 py-2 flex items-center gap-2 border border-slate-100">
                ...
                <p className="text-[11px] text-slate-600">
                  Credentials filled ΓÇö <strong>{email}</strong> / <strong>{password}</strong>
                </p>
              </div>
            )}
          </div>
