  ...
  const getStatusStyles = (status: string) => {
    const statusMap: Record<string, { bg: string; text: string; label: string }> = {
      ...
      'Pending Mugesh Invoice Upload': {
        bg: 'bg-amber-100',
        text: 'text-amber-700',
        label: 'Mugesh Invoice',
      },
      'Pending RFQ CFO Approval': { bg: 'bg-amber-100', text: 'text-amber-700', label: 'Pending Mugesh' },
      'Pending RFQ Mugesh Approval': { bg: 'bg-amber-100', text: 'text-amber-700', label: 'Pending Mugesh' },
      Approved: { bg: 'bg-emerald-100', text: 'text-emerald-700', label: 'Approved' },
